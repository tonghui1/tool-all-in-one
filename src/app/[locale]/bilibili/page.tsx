      ...
      <div className={`mt-6 p-4 rounded-md bg-red-50}`}>
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-medium text-red-600 dark:text-red-400">{t("error_toast_6")}</h3>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                ...
                <ul className="list-disc list-inside my-3 ml-2 space-y-1">
                  ...
                  <li>{t("faq_link_content_5")}</li>
                </ul>
                <p>{t("faq_link_content_6")}</p>
              </AccordionContent>
            </AccordionItem>
